...
* 
*/
class Page_Model_DbTable_Hoteles
{
	protected $_name = null;
	protected $_id = null;
	public function getHotel_id_name(){
		$curl = curl_init();
		
		curl_setopt_array($curl, array(
		  CURLOPT_URL => "http://localhost/api_rest_slim/public/api/hoteles/name/id",
	...
	public function getByIdApi($id){
		...
		curl_setopt_array($curl, array(
		  CURLOPT_URL => "http://localhost/api_rest_slim/public/api/hoteles".$id,
		  CURLOPT_RETURNTRANSFER => true,
		  CURLOPT_TIMEOUT => 5,
		  CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
		  CURLOPT_CUSTOMREQUEST => "GET",
	...
	public function getAllApi(){
		...
		curl_setopt_array($curl, array(
		  CURLOPT_URL => "http://localhost/api_rest_slim/public/api/hoteles",
		  CURLOPT_RETURNTRANSFER => true,
		  CURLOPT_TIMEOUT => 5,
		  CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
		  CURLOPT_CUSTOMREQUEST => "GET",
