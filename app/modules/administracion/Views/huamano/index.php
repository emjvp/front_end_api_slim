        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="humano_nombre" value="<?php echo $this->getObjectVariable($this->filters, 'humano_nombre') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
					<label>Faccion</label>
	                <label class="input-group">
	                    ...
	                    <select class="form-control" name="humano_faccion">
	                        ...
	                        <?php foreach ($this->list_humano_faccion as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'humano_faccion') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
	                ...
	                <label class="input-group">
	                    ...
	                    <select class="form-control" name="humano_trabajo">
	                        ...
	                        <?php foreach ($this->list_humano_trabajo as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'humano_trabajo') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->humano_id; ?>
					<tr>
						<td><?=$content->humano_nombre;?></td>
						<td><?= $this->list_humano_faccion[$content->humano_faccion];?>
						<td><?= $this->list_humano_trabajo[$content->humano_trabajo];?>
						<td>
