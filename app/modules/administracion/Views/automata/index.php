        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="automata_nombre" value="<?php echo $this->getObjectVariable($this->filters, 'automata_nombre') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
					<label>Tipo</label>
	                <label class="input-group">
	                    ...
	                    <select class="form-control" name="automata_tipo">
	                        <option value="">Todas</option>
	                        <?php foreach ($this->list_automata_tipo as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'automata_tipo') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->automata_id; ?>
					<tr>
						<td><?=$content->automata_nombre;?></td>
						<td><?= $this->list_automata_tipo[$content->automata_tipo];?>
						<td>
