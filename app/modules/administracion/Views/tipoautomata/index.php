        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="tipo_automata_nombre" value="<?php echo $this->getObjectVariable($this->filters, 'tipo_automata_nombre') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>Imagen</label>
		            ...
		            <input type="text" class="form-control" name="tipo_automata_imagen" value="<?php echo $this->getObjectVariable($this->filters, 'tipo_automata_imagen') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->tipo_automata_id; ?>
					<tr>
						<td><?=$content->tipo_automata_nombre;?></td>
						<td>
							<?php if($content->tipo_automata_imagen) { ?>
								<img src="/images/<?= $content->tipo_automata_imagen; ?>"  class="img-thumbnail thumbnail-administrator" />
							<?php } ?>
							<div><?= $content->tipo_automata_imagen; ?></div>
						</td>
						<td>
