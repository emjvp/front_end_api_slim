        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="humano_trabajo_nombre" value="<?php echo $this->getObjectVariable($this->filters, 'humano_trabajo_nombre') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>Imagen</label>
		            ...
		            <input type="text" class="form-control" name="humano_trabajo_imagen" value="<?php echo $this->getObjectVariable($this->filters, 'humano_trabajo_imagen') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->humano_trabajo_id; ?>
					<tr>
						<td><?=$content->humano_trabajo_nombre;?></td>
						<td>
							<?php if($content->humano_trabajo_imagen) { ?>
								<img src="/images/<?= $content->humano_trabajo_imagen; ?>"  class="img-thumbnail thumbnail-administrator" />
							<?php } ?>
							<div><?= $content->humano_trabajo_imagen; ?></div>
						</td>
						<td>
