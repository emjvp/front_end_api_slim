<?php
/**
* Controlador de Humano que permite la  creacion, edicion  y eliminacion de los Hu del Sistema
*/
class Administracion_humanoController extends Administracion_mainController
{
	/**
	 * $mainModel  instancia del modelo de  base de datos Hu
	 ...
	 * @var string
	 */
	protected $_csrf_section = "administracion_humano";
	...
	/**
     * Inicializa las variables principales del controlador humano .
     *
     * @return void.
     */
	public function init()
	{
		$this->mainModel = new Administracion_Model_DbTable_Humano();
		$this->namefilter = "parametersfilterhumano";
		$this->route = "/administracion/humano";
		$this->namepages ="pages_humano";
		$this->namepageactual ="page_actual_humano";
	...
	/**
     * Recibe la informacion y  muestra un listado de  Hu con sus respectivos filtros.
     *
     * @return void.
     */
	public function indexAction()
	{
		$title = "Aministración de Hu";
	...
	{
		$this->_view->route = $this->route;
		$this->_csrf_section = "manage_humano_".date("YmdHis");
	...
	/**
     * Inserta la informacion de un Humano  y redirecciona al listado de Hu.
     *
     * @return void.
     */
	...
	/**
     * Recibe un identificador  y Actualiza la informacion de un Humano  y redirecciona al listado de Hu.
     *
     * @return void.
     */
	...
	/**
     * Recibe un identificador  y elimina un Humano  y redirecciona al listado de Hu.
     *
     * @return void.
     */
	...
	/**
     * Recibe la informacion del formulario y la retorna en forma de array para la edicion y creacion de Humano.
     *
	...
	private function getData()
	{
		...
		$data['humano_descipcion'] = $this->_getSanitizedParamHtml("humano_descipcion");
    ...
    protected function filters()
    {
        if ($this->getRequest()->isPost()== true) {
            ...
            $parramsfilter = array();
					...
					$parramsfilter['humano_faccion'] =  $this->_getSanitizedParam("humano_faccion");Session::getInstance()->set($this->namefilter, $parramsfilter);
        }
